        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`px-4 py-3 rounded-full font-semibold text-sm transition-all duration-75 ${isActive
      ...
      <div className="flex-1 min-w-0 relative" ref={searchRef}>
        <div className="relative">
          ...
          <input
            ...
            className={`w-full h-12 pl-12 pr-10 rounded-full border-none outline-none transition-all text-base placeholder:text-pinterest-mediumGray ${isSearchOpen
